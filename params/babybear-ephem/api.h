...
#define PQCLEAN_NAMESPACE_CRYPTO_PUBLICKEYBYTES 804
#define PQCLEAN_NAMESPACE_CRYPTO_BYTES 32
#define PQCLEAN_NAMESPACE_CRYPTO_CIPHERTEXTBYTES 917
#define PQCLEAN_NAMESPACE_CRYPTO_ALGNAME "BabyBearEphem"
